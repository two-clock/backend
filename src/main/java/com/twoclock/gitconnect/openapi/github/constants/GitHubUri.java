...
public enum GitHubUri {
    ...
    MY_GITHUB_INFO(HttpMethod.GET, "https://api.github.com/user"),
    ...
    MY_REPOSITORY_LIST(HttpMethod.GET, "https://api.github.com/user/repos?sort=created&per_page=100"),
    USER_REPOSITORY_LIST(HttpMethod.GET, "https://api.github.com/users/%s/repos?sort=created&per_page=100");
